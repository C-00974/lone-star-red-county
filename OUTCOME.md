...
**Tip SHA:** `911a530` (CT America/Chicago build window Sep 24, 2026)
...
None for Soft Open Quiet vertical. Headed GPU smoke not automated in this pass — play URL is live for Chris.
