...
**Tip SHA:** `8a984de` (craft standards pass · CT America/Chicago Sep 24, 2026)
...
- **Spawn** — horse yaw aimed at alley case so first look is not empty desert.
...
### Pass 1 — Visibility
- FogExp2 density 0.018 → milder `Fog(0x2a1818, 28, 95)`; background lifted off near-black
...
- Camera tighter/higher (y 4.1, z -6.2) so horse reads in frame
